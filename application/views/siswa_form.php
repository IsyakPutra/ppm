	    ...
	    <tr><td>Umur <?php echo form_error('umur') ?></td>
	       ...
	       <tr>
                ...
                <td>
                      ...
                      <input type="radio" name="darah" id="optionsRadios1" value="option1" checked>
                      Belum Tahu
                    
                  
                      <input type="radio" name="darah" id="optionsRadios2" value="option2">
                      A
                    
                    <input type="radio" name="darah" id="optionsRadios3" value="option3" >
                      B
                    
                      <input type="radio" name="darah" id="optionsRadios4" value="option4">
                      AB
                    
                      <input type="radio" name="darah" id="optionsRadios5" value="option5">
                      O
