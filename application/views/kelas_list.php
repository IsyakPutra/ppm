	    ...
	    <tbody>
			...
			echo '  '; 
			echo anchor(site_url('kelas/delete/'.$kelas->id_kelas),'<i class="fa fa-trash-o"></i>','title="delete" class="btn btn-danger btn-sm" onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
			?>
		    </td>
	        </tr>
                <?php
